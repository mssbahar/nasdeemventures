...
import { CheckCircle, Fuel, Shield, Truck, Award } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen">
      ...
      <HeroSection
        ...
        subtitle="High-quality petroleum products for industrial and commercial use"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                We supply high-quality petroleum products for various industrial and commercial 
                applications. Our KPDNKK-licensed operations ensure quality assurance and 
                regulatory compliance.
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                From bulk supply to specialized products, we provide comprehensive petroleum 
                solutions tailored to your specific needs.
              </p>
              <div className="flex items-center space-x-4">
                <Award className="w-8 h-8 text-accent" />
                <div>
                  <div className="text-lg font-semibold text-primary">KPDNKK Licensed</div>
      ...
      <SectionWrapper className="bg-muted">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-lg shadow-lg p-12">
            <Fuel className="w-16 h-16 text-accent mx-auto mb-6" />
            <h2 className="text-3xl lg:text-4xl font-bold text-primary mb-4">
              Coming Soon
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              We are currently developing comprehensive information about our petroleum products 
